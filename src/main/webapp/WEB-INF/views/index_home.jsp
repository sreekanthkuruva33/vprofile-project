                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <i class="brand_network"><small><small>Yoo</small></small></i>
                        </div>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">wide range of courses to help students get job placement in various IT job roles with major companies.
	    </p>
	    <p><strong>Address:</strong> #41,shree nilay , mathikere bangalore 560054</p> 
	    <p><strong>Ph No: </strong>  +91-9834843396</p>
		<p><strong>E-Mail ID :</strong> abhay.desai0001@gmail.com</p>
  	</div>
   </div>
